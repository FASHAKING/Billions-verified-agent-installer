...
# ============================================================
#  Verified Agent Identity — All-in-One Installer for macOS
...
#    1. Installs Homebrew (if not present), Node.js and Git
...
# ============================================================
print_step "1/5" "Checking and installing prerequisites"
